...
const navigate = useNavigate();
  ...
  const accordionRows =
    Array.isArray(product.detailsSections) && product.detailsSections.length > 0
  ...
  return (
    ...
    >
      ...
      <div className={styles.optionSection}>
        ...
        {/* Shipping BY date (keeps neutral look) */}
        ...
        {/* Heading for the small features */}
        <div className={styles.featuresHeading}>Your order includes</div>

        {/* Free features (first two will be colorful via CSS targeting) */}
